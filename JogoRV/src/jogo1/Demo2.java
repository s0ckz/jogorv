...
public class Demo2 extends SimpleGame {
    ...
    public static void main(String[] args) {
        try {
            ...
            logger.logp(Level.SEVERE, Demo2.class.toString(),
    ...
    protected void simpleInitGame() {
        display.setTitle("Demonstração 2 - Realidade Virtual");
    ...
    private void configurarPersonagem() {
        ...
        ts.setTexture(
            ...
            Demo2.class.getClassLoader().getResource(
    ...
    private void configurarTerreno() {
        ...
        Texture t2 = TextureManager.loadTexture(Demo2.class
                .getClassLoader()
    ...
    private void configurarMonstros() {
    	try {
    		Collection<Node> monstros = GerenciadorMonstros.getInstance().getMonstros(1);
